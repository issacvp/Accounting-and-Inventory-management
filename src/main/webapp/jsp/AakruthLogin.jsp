...
<body id="page">
	...
	<div class="login-card">
		...
		<form action="/Aakruth/login" class="form-signin" method="post">
			<span class="reauth-email"> </span> <input class="form-control"
				type="email" pattern="[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" required placeholder="Email address" autofocus
				autocomplete="off" id="inputEmail" name="email"> <input
